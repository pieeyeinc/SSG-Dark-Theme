...
$(document).ready(function () {
	...
	$('body>header').css('background', config_data.color.headerBackground);
	$('body>header').css('color', config_data.color.navText);
	$('body>footer').css('background', config_data.color.footerBackground);
	$('body>footer').css('color', config_data.color.footerText);
	$("#logo").attr("src", config_data.contents.logoUrl);
	$(".footer > p").text(config_data.contents.footerText);
